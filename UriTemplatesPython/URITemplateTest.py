...
class URITemplateTest(unittest.TestCase):
    ...
    def testParse(self):
        ...
        self.doTestParse2()
        self.doTestParse3()
        self.doTestTimeParser1('ac27_crn$x_$Y$j00-$(Y;end)$(j;end)00.gif', 'ac27_crn1926_199722300-199725000.gif', '1997-223T00:00/1997-250T00:00')
        ...
        self.doTestTimeParser1('/gif/ac_$Y$j$H-$(Y;end)$j$H.gif', '/gif/ac_199733000-199733100.gif', '1997-11-26T00:00Z/1997-11-27T00:00Z')
